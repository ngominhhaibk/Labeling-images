...
class LabelTool():
    def __init__(self, master):
        ...
        self.frame = Frame(self.parent, bg='Pink')
        ...
        for i in range(len(binary_label)):
            self.chooselbl = Label(self.frame, text = binary_label[i], bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Car", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Motorbike", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Bikes", bg='Pink')
        ...
        # Categories of car
        self.chooselbl = Label(self.frame, text = "Categories", bg='Pink', anchor = CENTER)
        ...
        self.chooselbl = Label(self.frame, text = "Sedan", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "SUV", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Minivan", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Microbus", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Car>=24seats", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Bus", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Truck", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Police", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Ambulance", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Fire Truck", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Taxi", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Others", bg='Pink')
        ...
        # Space
        self.chooselbl = Label(self.frame, text = "        ", bg='Pink')
        self.chooselbl.grid(row = 1, column = 5, sticky=W+N)
        
        #   Make:
        self.chooselbl = Label(self.frame, text = "Make       ", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Toyota", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Ford", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Kia", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Mazda", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Honda", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Huyndai", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Mercedes", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Vinfast", bg='Pink')
        ...
        #   Color:
        self.chooselbl = Label(self.frame, text = "Color       ", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "White", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Silver", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Black", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Blue", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Red", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Brown", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Gray", bg='Pink')
        ...
        self.chooselbl = Label(self.frame, text = "Green", bg='Pink')
    ...
    def loadDir(self, dbg = False):
        ...
        if not os.path.exists('E:/CMC/Annotation_tool_PAR-main/Labels2'):
            os.mkdir('E:/CMC/Annotation_tool_PAR-main/Labels2')
    ...
    def deleteImage(self):
        self.saveImage()
        shutil.move(self.labelfilename, os.path.join('./Deleted_label',self.labelfilename.split('/')[0]))
        shutil.move(self.imagefilename, os.path.join('./Deleted_image',self.imagefilename.split('/')[0]))
        if self.cur < self.total:
            self.cur += 1
            self.loadImage()
        else:
